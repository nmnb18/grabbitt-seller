    ...
    return (
        ...
        >
            ...
            {loading && <View style={styles.loader}>
                ...
                <Text style={{ marginTop: 10 }}>Loading redemptions...</Text>
            </View>}
            {!redemptions.length && !loading && <View style={styles.loader}>
                    ...
                    >
                        <Card.Content>
                            ...
                            <View style={styles.headerRow}>
                                <Text style={styles.shopName}>{item.seller_shop_name}</Text>
                            ...
                            <View style={styles.row}>
                                ...
                                <Text style={styles.userEmail}>{item.user_email}</Text></View>

                            {/* OFFER */}
                            <View style={styles.row}>{item.offer_name && (
